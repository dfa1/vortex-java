...
public record ALPMetadata(
    ...
    public static ALPMetadata decode(MemorySegment __seg, long __off, long __len) throws IOException {
        ...
        return new ALPMetadata(exp_e, exp_f, patches);
    }
