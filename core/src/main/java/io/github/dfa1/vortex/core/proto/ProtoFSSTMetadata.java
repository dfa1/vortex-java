...
public record ProtoFSSTMetadata(
    ...
    public static ProtoFSSTMetadata decode(MemorySegment __seg, long __off, long __len) throws IOException {
        ...
        return new ProtoFSSTMetadata(uncompressed_lengths_ptype, codes_offsets_ptype);
    }
