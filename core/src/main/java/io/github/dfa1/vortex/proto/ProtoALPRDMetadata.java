...
public record ProtoALPRDMetadata(
        int right_bit_width,
        int dict_len,
        java.util.List<Integer> dict,
        ProtoPType left_parts_ptype,
    ...
    public static ProtoALPRDMetadata decode(MemorySegment __seg, long __off, long __len) throws IOException {
        ProtoReader r = new ProtoReader(__seg, __off, __len);
        int right_bit_width = 0;
        int dict_len = 0;
        java.util.List<Integer> dict = new java.util.ArrayList<>();
        ProtoPType left_parts_ptype = ProtoPType.U8;
        ...
        while (r.hasMore()) {
            ...
            switch (tag >>> 3) {
                ...
                case 4 -> {
                    ...
                    try {
                        left_parts_ptype = ProtoPType.fromValue(__ev);
        ...
        return new ProtoALPRDMetadata(right_bit_width, dict_len, dict, left_parts_ptype, patches);
    }
