...
public record Decimal(
    ...
    public static Decimal decode(MemorySegment __seg, long __off, long __len) throws IOException {
        ...
        return new Decimal(precision, scale, nullable);
    }
