...
public record ProtoPrimitive(
    ...
    public static ProtoPrimitive decode(MemorySegment __seg, long __off, long __len) throws IOException {
        ProtoReader r = new ProtoReader(__seg, __off, __len);
        ProtoPType type = ProtoPType.U8;
        ...
        while (r.hasMore()) {
            ...
            switch (tag >>> 3) {
                case 1 -> {
                    ...
                    try {
                        type = ProtoPType.fromValue(__ev);
        ...
        return new ProtoPrimitive(type, nullable);
    }
