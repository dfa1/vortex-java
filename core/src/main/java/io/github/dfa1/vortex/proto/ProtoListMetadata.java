...
public record ProtoListMetadata(
        long elements_len,
    ...
    public static ProtoListMetadata decode(MemorySegment __seg, long __off, long __len) throws IOException {
        ...
        return new ProtoListMetadata(elements_len, offset_ptype);
    }
