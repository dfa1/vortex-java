...
public record ProtoVarBinMetadata(
        ProtoPType offsets_ptype
) {
    ...
    public static ProtoVarBinMetadata decode(MemorySegment __seg, long __off, long __len) throws IOException {
        ProtoReader r = new ProtoReader(__seg, __off, __len);
        ProtoPType offsets_ptype = ProtoPType.U8;
        while (r.hasMore()) {
            ...
            switch (tag >>> 3) {
                case 1 -> {
                    ...
                    try {
                        offsets_ptype = ProtoPType.fromValue(__ev);
        ...
        return new ProtoVarBinMetadata(offsets_ptype);
    }
