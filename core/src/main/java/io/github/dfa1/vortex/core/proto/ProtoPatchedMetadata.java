...
public record ProtoPatchedMetadata(
        int n_patches,
        int n_lanes,
        int offset
) {
    ...
    public static ProtoPatchedMetadata decode(MemorySegment __seg, long __off, long __len) throws IOException {
        ...
        return new ProtoPatchedMetadata(n_patches, n_lanes, offset);
    }
