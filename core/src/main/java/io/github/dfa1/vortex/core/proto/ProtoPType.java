...
public enum ProtoPType {
    ...
    public static ProtoPType fromValue(int value) {
        for (ProtoPType v : values()) {
            if (v.value == value) {
                return v;
            }
        }
        throw new IllegalArgumentException("unknown ProtoPType value: " + value);
    }
}
