...
public record ZstdMetadata(
        int dictionary_size,
        java.util.List<ZstdFrameMetadata> frames
) {
    ...
    public static ZstdMetadata decode(MemorySegment __seg, long __off, long __len) throws IOException {
        ...
        while (r.hasMore()) {
            ...
            switch (tag >>> 3) {
                ...
                case 2 -> {
                    ...
                    frames.add(ZstdFrameMetadata.decode(__slice, 0, __slice.byteSize()));
                }
                default -> r.skipField(tag & 7);
            }
        }
        return new ZstdMetadata(dictionary_size, frames);
    }
