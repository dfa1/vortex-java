...
public record ProtoVariant(
    ...
    public static ProtoVariant decode(MemorySegment __seg, long __off, long __len) throws IOException {
        ...
        return new ProtoVariant(nullable);
    }
