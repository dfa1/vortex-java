...
public final class FbsStruct_ extends FbsTable {

    /// Positions a reader at the root table of a finished buffer.
    /// @param seg the buffer
    /// @return a reader positioned at the root
    public static FbsStruct_ getRootAsFbsStruct_(MemorySegment seg) {
        return new FbsStruct_().assign(seg, FbsTable.rootPosition(seg, 0));
    }
    ...
    /// @return this
    public FbsStruct_ assign(MemorySegment seg, long position) {
        init(seg, position);
        return this;
    }
    ...
    /// Builds a `FbsStruct_` table.
    /// @param b the builder
    /// @param namesOffset field value
    /// @param dtypesOffset field value
    /// @param nullable field value
    /// @return the table offset
    public static int createFbsStruct_(FbsBuilder b, int namesOffset, int dtypesOffset, boolean nullable) {
        b.startTable(3);
    ...
    /// Begins a `FbsStruct_` table.
    /// @param b the builder
    public static void startFbsStruct_(FbsBuilder b) {
        b.startTable(3);
    }

    /// Finishes a `FbsStruct_` table.
    /// @param b the builder
    /// @return the table offset
    public static int endFbsStruct_(FbsBuilder b) {
        return b.endTable();
    }

    /// Finishes the buffer with a `FbsStruct_` root.
    /// @param b the builder
    /// @param offset the root table offset
    public static void finishFbsStruct_Buffer(FbsBuilder b, int offset) {
        b.finish(offset);
    }
}
