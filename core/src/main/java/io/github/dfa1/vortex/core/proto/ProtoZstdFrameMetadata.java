...
public record ProtoZstdFrameMetadata(
    ...
    public static ProtoZstdFrameMetadata decode(MemorySegment __seg, long __off, long __len) throws IOException {
        ...
        return new ProtoZstdFrameMetadata(uncompressed_size, n_values);
    }
