...
public record ProtoPcoPageInfo(
        int n_values
) {
    ...
    public static ProtoPcoPageInfo decode(MemorySegment __seg, long __off, long __len) throws IOException {
        ...
        return new ProtoPcoPageInfo(n_values);
    }
