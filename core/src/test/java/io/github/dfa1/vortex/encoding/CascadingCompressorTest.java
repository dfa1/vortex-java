...
class CascadingCompressorTest {
	...
	// ── depth>0 cascades ALP+Bitpacked for F64 ───────────────────────────────
	...
	// ── round-trip: ALP + Bitpacked F64 ──────────────────────────────────────

	@Test
	void roundTrip_alpBitpacked_f64() {
		// Given
	...
	// ── round-trip: FoR + Bitpacked I64 ──────────────────────────────────────

	@Test
	void roundTrip_forBitpacked_i64() {
	...
	// ── round-trip: Dict + Bitpacked I32 ─────────────────────────────────────

	@Test
	void roundTrip_dictBitpacked_i32() {
	...
	// ── exclusion list prevents self-recursion ────────────────────────────────
