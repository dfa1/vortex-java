...
/// {@code getInt(i) = values.getInt(codes.getCode(i))}. Per ADR 0012, this
...
/// @param values dictionary pool — element at code {@code c} is {@code values.getInt(c)}
...
public record DictIntArray(DType dtype, long length, IntArray values, Array codes) implements IntArray {
    ...
    /// Builds a {@link DictIntArray}, validating that {@code codes} is one of the
