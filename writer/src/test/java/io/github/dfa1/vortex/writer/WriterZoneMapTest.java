...
class WriterZoneMapTest {
    ...
    private static Path write(Path tmp, boolean zoneMaps) throws IOException {
        WriteOptions opts = new WriteOptions(4, zoneMaps, 0.90, 0, true, false, MemorySize.ofMiB(256), Map.of());
    ...
    void zoneMaps_nullableColumn_recordsPerZoneNullCount(@TempDir Path tmp) throws IOException {
        ...
        WriteOptions opts = new WriteOptions(2, true, 0.90, 0, true, false, MemorySize.ofMiB(256), Map.of());
    ...
    void noChunks_emitsNoZoneMap(@TempDir Path tmp) throws IOException {
        ...
        WriteOptions opts = new WriteOptions(4, true, 0.90, 0, false, false, MemorySize.ofMiB(256), Map.of());
    ...
    void dictColumn_emitsStringMinMaxZoneMapWrappingDict(@TempDir Path tmp) throws IOException {
        ...
        DType.Struct schema = new DType.Struct(
                List.of(ColumnName.of("s")), List.of(DType.UTF8), false);
        WriteOptions opts = new WriteOptions(6, true, 0.90, 0, true, false, MemorySize.ofMiB(256), Map.of());
    ...
    void zoneMaps_f64StatsPayloadDecodesPerZoneMinMaxSum(@TempDir Path tmp) throws IOException {
        ...
        WriteOptions opts = new WriteOptions(4, true, 0.90, 0, true, false, MemorySize.ofMiB(256), Map.of());
