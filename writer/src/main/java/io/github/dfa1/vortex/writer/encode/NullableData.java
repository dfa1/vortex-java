...
///
/// {@code values} carries the raw storage in the shape an [Encoding] expects
...
///
/// The writer recognises this shape and emits the {@code vortex.masked}
...
///
/// Invariant: {@code values} length (or storage row count) matches
