...
- Opt-in [Jazzer](https://github.com/CodeIntelligenceTesting/jazzer) coverage-guided fuzz targets for `VortexReader`'s full-file open path and `PostscriptParser.parseBlobs`, tagged out of routine test runs; see [ADR-0020](adr/0020-jazzer-fuzz-infrastructure.md). ([b90a7ebf](https://github.com/dfa1/vortex-java/commit/b90a7ebf))
